...
class NeatoTrackerColor(Node):
    ...
    def loop_wrapper(self):
        ...
        cv2.createTrackbar('speed', 'binary_window', 0, 5, self.set_angular_speed_lower_bound)
        cv2.createTrackbar('lin_speed', 'binary_window', 0, 5, self.set_linear_speed_lower_bound)
    ...
    def set_angular_speed_lower_bound(self, val):
        """ A callback function to handle the OpenCV slider to select the red lower bound """
        self.rot_p = val
    
    def set_linear_speed_lower_bound(self, val):
        """ A callback function to handle the OpenCV slider to select the red lower bound """
        self.linSpeed = val/5.0
    ...
    def process_mouse_event(self, event, x,y,flags,param):
        ...
        cv2.putText(self.image_info_window,
                    ...
                    1,
                    (0,0,0))
        # Controls whether the robot should move
        # if event == cv2.EVENT_LBUTTONDOWN:
        #     self.should_move = not(self.should_move)
